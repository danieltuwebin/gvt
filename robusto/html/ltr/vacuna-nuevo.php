...
<head>
    ...
    <title>Nueva Vacuna - Sistema Vet. TuWebIn</title>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Nueva Vacuna</h2>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Datos de Vacuna</h4>
                                        ...
                                        <form class="form" id="FormularioVacuna">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="CboEstadoVacuna">Estado </label>
...
<script type="text/javascript">
    ...
    function Obtener_Vacunas(act, id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#CboVacuna").empty();
                $("#CboVacuna").append('<option selected="true" disabled="disabled">SELECCIONE VACUNA</option>');
    ...
    $('#btnAgendar').click(function() {
        if (IdTipoProcesoGrabacion == 0) {
            ...
            if ($("#CboEstadoVacuna").val()==3){
                ProcesoGrabacion(2, IdVacuna , 3);
            }else{
                alert('Debe cambiar el estado de la vacuna a Reprogramado');                
                $("#CboEstadoVacuna").focus();
                $("#CboEstadoVacuna").select();
            }
        }
    });
    ...
    $("#btnGrabar").click(function() {
        if (IdTipoProcesoGrabacion == 0) {
            ...
            if ($("#CboEstadoVacuna").val()==1){
                ...
                alert('Debe cambiar el estado de la vacuna a Realizado');                
                $("#CboEstadoVacuna").focus();
                $("#CboEstadoVacuna").select();
            }
        }
    ...
    function RegistrarVacuna(act, IdTipoRegistro, Idvacuna, Fecha, IdProducto, Precio, IdMascota, Observacion, Cita, Usuario, VentaTipo, Cantidad, IdAlmacen) {
        //console.log(act +'-'+ IdTipoRegistro+'-'+ Idvacuna+'-'+ Fecha+'-'+ IdProducto+'-'+ Precio+'-'+ IdMascota+'-'+ Observacion+'-'+ Cita+'-'+ Usuario+'-'+ VentaTipo+'-'+ Cantidad+'-'+ IdAlmacen);
        $.ajax({
            type: "POST",
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(json, function(i, item) {
                    ...
                    $("#CboVacuna option[value=" + $('#Txt_CodigoProducto').val() + "]").attr("selected", true);
