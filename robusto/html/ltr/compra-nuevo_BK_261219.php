                                    ...
                                    <div class="card-block">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="text-transform:uppercase;" id="Txt_Precio" class="form-control" placeholder="Ingrese nombre" name="Txt_Precio">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="text-transform:uppercase;" id="TxtCantidad" class="form-control" placeholder="Ingrese nombre" name="TxtCantidad" onkeypress="return SoloNumeros(event);">
                                                            <input type="hidden" id="Txt_Codigo" name="Txt_Codigo">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 offset-md-10">
                                                <div class="form-group">
                                                    <p class="text-xs-right">all viewport sizes.</p>
                                                    <p class="text-xs-right">Right aligned.</p>
                                                    <input type="hidden" id="Txt_Codigo" name="Txt_Codigo">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group" style="text-align:center;">
                                                <div class="row">
                                                    ...
                                                    <button id="BtnActualizarMascota" type="button" class="btn btn-success mr-1"><i class="icon-eyedropper"></i> Grabar Compra</button>
                                                    <button id="BtnActualizarMascota" type="button" class="btn btn-success mr-1"><i class="icon-droplet"></i> Nuevo Baño</button>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function Grabar_Compra(act, IdCompra, IdProducto, Precio, Cantidad, Usuario, Sede) {
        $.ajax({
            ...
            complete: function() {
                ...
                /*                 var total = 0;
                                $('#TblCompra').DataTable().rows().data().each(function(el, index) {
                ...
                /*                 var suma = 0;
                                $('#TblCompra tr.dato').each(function() { //filas con clase 'dato', especifica una clase, asi no tomas el nombre de las columnas
    ...
    $('#TblCompra').on('click', '.editar', function() {
        var id = $(this).val();
    ...
    $("#TxtProducto").keyup(function() {
        ...
        //$("#productos").html('<option>PNG</option><option>JPEG</option><option>GIF</option><option>TGA</option>');
    ...
    $("#TxtProducto").change(function() {
        ...
        console.log($('#productos [value="' + value + '"]').data('value'));
