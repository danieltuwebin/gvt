      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.php" class="navbar-brand nav-link"><img alt="branding logo" src="../../app-assets/images/logo/gavet-logo-dark.png" data-expand="../../app-assets/images/logo/gavet-logo-dark.png" data-collapse="../../app-assets/images/logo/gavet-logo-small.png" class="brand-logo"></a></li>
            <!-- <li class="nav-item"><a href="index.php" class="navbar-brand nav-link"><img alt="branding logo" src="../../app-assets/images/logo/gavet-logo-light.png" data-expand="../../app-assets/images/logo/gavet-logo-light.png" data-collapse="../../app-assets/images/logo/gavet-logo-small.png" class="brand-logo"></a></li> -->
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  -->
                  <a href="#" id="Salir" class="dropdown-item">
                    <i class="icon-power3"></i> Cerrar Sesion
                  </a>
                </div>
              </li>
