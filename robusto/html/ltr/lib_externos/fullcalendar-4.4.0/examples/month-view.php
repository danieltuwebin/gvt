...
<script type='text/javascript' src='../packages/'></script>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link active" href="https://www.jose-aguilar.com/scripts/jquery/fullcalendar/">Demo <span class="sr-only">(current)</span></a>
            <a class="nav-item nav-link" href="https://www.jose-aguilar.com/scripts/jquery/fullcalendar/fullcalendar.zip">Descargar</a>
            <a class="nav-item nav-link" href="https://www.jose-aguilar.com/blog/fullcalendar-con-jquery/">Tutorial</a>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="https://www.jose-aguilar.com/blog/fullcalendar-con-jquery/">Tutorial</a></li>
          <li class="breadcrumb-item active">Fullcalendar Demo</li>
        </ol>
    </nav>
    ...
    <div class="footer-content row">
        <div class="col-lg-12">
            <div class="pull-right">
                <a href=" https://www.jose-aguilar.com/blog/fullcalendar-con-jquery/" class="btn btn-secondary">
                    <i class="fa fa-reply"></i> volver al tutorial
                </a>
                <a href="https://www.jose-aguilar.com/scripts/jquery/fullcalendar/fullcalendar.zip" class="btn btn-primary">
