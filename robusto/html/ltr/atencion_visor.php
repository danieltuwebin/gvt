...
$Atencion_Fecha = date('d-m-Y', strtotime($dt['Atencion_Fecha']));
...
$pdf->Cell(20 ,5,$Atencion_Fecha,0,0);
$pdf->Cell(10);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(3 ,5,utf8_decode('T° :'),0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
$pdf->Cell(15 ,5,$Atencion_T,0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(7 ,5,'F.C. :',0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
$pdf->Cell(15 ,5,$Atencion_FC,0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(7 ,5,'F.R. :',0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
...
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
$pdf->Cell(10 ,5,$Atencion_sc_Deshidratacion,0,0);
$pdf->Cell(3);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(15 ,5,utf8_decode('Mucosa : '),0,0);
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
$pdf->Cell(30 ,5,$Atencion_sc_Mucosas,0,0);
$pdf->Cell(15);
$pdf->SetFont('Arial','B',12);
...
$pdf->Cell(5);
$pdf->SetFont('Arial','',12);
$pdf->Cell(5 ,5,$Atencion_sc_Diarreas,0,0);
$pdf->Cell(7);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(21 ,5,utf8_decode('Ganglios : '),0,0);
$pdf->Cell(1);
$pdf->SetFont('Arial','',12);
$pdf->Cell(45 ,5,$Atencion_sc_Ganglios,0,0);
$pdf->Cell(13);
$pdf->SetFont('Arial','B',12);
...
$pdf->SetX(20);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(8 ,5,utf8_decode('Anamnesis'),0,0);
...
$pdf->SetX(55);
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(135,5,utf8_decode($Atencion_dx_Presuntivo),0, 'J');
$pdf->Ln(2);
...
$pdf->SetX(55);
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(135,5,utf8_decode($Atencion_dx_Definitivo),0, 'J');
$pdf->Ln(2);
...
$pdf->MultiCell(135,5,utf8_decode($Atencion_dx_Solicitado),0, 'J');
