        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Especies</h2>
                </div>
            </div>
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Nueva Especie</h4>
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <form class="form" id="FormularioEspecie">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="Txt_Nombre">Nombre</label>
                                                            <input type="text" style="text-transform:uppercase;" id="Txt_Nombre" class="form-control" placeholder="Ingrese Especie" name="Txt_Nombre" onkeyup="javascript:this.value=this.value.toUpperCase();" onkeypress="return soloLetras(event)">
                        ...
                        <div id="VistaDetalle">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form">Listado de Especie</h4>
                                        <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                                <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table id="TblEspecies" class="table table-striped table-bordered nowrap" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                            <th>Nombre</th>
...
<script type="text/javascript">
    ...
    var listar = function() {
        table = $('#TblEspecies').DataTable({
            "destroy": true,
            "ajax": {
                "method": "POST",
                "url": "modulos/especies_listado.php"
                //"dataSrc": ""
            },
            /* OCULTAR COLUMNAS */
            /*
            ...
            */
            ...
            "columns": [{
                    "render": function(data, type, row) {
                        if (row.Especie_Id.length == 1) {
                            var Cod = 'E00' + row.Especie_Id;
                        } else if (row.Especie_Id.length == 2) {
                            var Cod = 'E0' + row.Especie_Id;
                        } else {
                            var Cod = 'E' + row.Especie_Id;
                        }
                        return Cod;
                    }
                },
    ...
    function Grabar_Especie(act, nombre, usuario) {
        $.ajax({
            type: "POST",
            url: "modulos/conf_especies.php",
            async: true,
            dataType: "html",
            data: ({
                action: act,
            ...
            success: function(data) {
                ...
                if (data == 1) {
                    $("#Resultado_Grabacion").html('<div class="alert alert-info alert-dismissible fade in mb-2" role="alert">' +
                        ...
                        '</button>' +
                        '<strong>Nueva especie registrada correctamente</strong>' +
                        '</div>')
                } else if (data == 2) {
                    $("#Resultado_Grabacion").html('<div class="alert alert-warning alert-dismissible fade in mb-2" role="alert">' +
                        ...
                        '<span aria-hidden="true">&times;</span>' +
                        '</button>' +
                        '<strong>No se grabo el registro, el nombre de la especie ya existe en el sistema</strong>' +
                        '</div>')
                } else {
    ...
    function Obtener_Datos_Especie(act, id) {
        $.ajax({
            type: "POST",
            url: "modulos/conf_especies.php",
            async: true,
            ...
            success: function(data) {
                ...
                $.each(json, function(i, item) {
                    $('#Txt_Codigo').val(json[i].Especie_Id);
                    $('#Txt_Nombre').val(json[i].Especie_Nombre);
                });
            },
            complete: function() {
                //alert('ok2');
            ...
            success: function(data) {
                if (data == 1) {
                    ...
                    $("#Resultado_Grabacion").html('<div class="alert alert-warning alert-dismissible fade in mb-2" role="alert">' +
                        ...
                        '<span aria-hidden="true">&times;</span>' +
                        '</button>' +
                        '<strong>No se actualizo el registro, el nombre de la especie ya existe en el sistema</strong>' +
                        '</div>')
                } else {
                    $("#Resultado_Grabacion").html('<div class="alert alert-danger alert-dismissible fade in mb-2" role="alert">' +
                        '<button type="button" class="close" data-dismiss="alert" aria-label="Close">' +
    ...
    function Eliminar_Especie(act, codigo) {
        $.ajax({
            type: "POST",
            url: "modulos/conf_especies.php",
            async: true,
