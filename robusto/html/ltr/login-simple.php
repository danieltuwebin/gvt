...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Login - Sistema Vet. Tuewebin</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <!--<div class="p-1"><img src="../../app-assets/images/logo/dog.png" alt="branding logo"></div>-->
                ...
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="index.html" novalidate>
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Ingrese usuario" required>
                            <div class="form-control-position">
                                <i class="icon-head"></i>
                            </div>
                        </fieldset>
                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" class="form-control form-control-lg input-lg" id="user-password" placeholder="Ingrese contraseña" required>
                            <div class="form-control-position">
                                <i class="icon-key3"></i>
                            </div>
                        </fieldset>
            ...
            <div class="card-footer">
                <div class="">
                    <p class="float-sm-left text-xs-center m-0">
                        <!--#<a href="recover-password.html" class="card-link">Recuperar Contraseña</a>-->
